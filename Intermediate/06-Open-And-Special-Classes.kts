/*
Nivel: Intermediate
Topico: Open and Special Classes
*/
...
val errorStatus: Status = Status.Error(Status.Error.Problem.NETWORK)
val okStatus: Status = Status.OK(listOf("Data1", "Data2"))

handleStatus(errorStatus)
handleStatus(okStatus)